...
import { NullIOBus } from '../core/io.js';
import { Registers } from '../core/registers.js';
...
export class CPU8086 {
     ...
     */
    repPrefix = null;
    constructor(memory, io = new NullIOBus(), intCtrl = NullInterruptController, traps) {
        this.memory = memory;
        this.io = io;
    ...
    step() {
        ...
        const maskableServicable = ctrl.hasMaskable() && this.flags.IF && !this.interruptInhibit;
        if (this.halted) {
