 ...
 */
export function flagsAdd8(flags, a, b, result) {
 ...
 */
export function flagsAdd16(flags, a, b, result) {
...
export function flagsSub8(flags, a, b, result) {
    const r8 = result & 0xFF;
    let f = flags.value;
    f = result & 0x100 ? (f | FLAG.CF) : (f & ~FLAG.CF);
    f = PARITY_TABLE[r8] ? (f | FLAG.PF) : (f & ~FLAG.PF);
...
export function flagsSub16(flags, a, b, result) {
    const r16 = result & 0xFFFF;
    let f = flags.value;
    f = result & 0x10000 ? (f | FLAG.CF) : (f & ~FLAG.CF);
    f = PARITY_TABLE[r16 & 0xFF] ? (f | FLAG.PF) : (f & ~FLAG.PF);
...
export function flagsLogic8(flags, result) {
    const r8 = result & 0xFF;
    let f = flags.value;
...
export function flagsLogic16(flags, result) {
    const r16 = result & 0xFFFF;
    let f = flags.value;
    f &= ~(FLAG.CF | FLAG.OF | FLAG.AF);
    f = PARITY_TABLE[r16 & 0xFF] ? (f | FLAG.PF) : (f & ~FLAG.PF);
...
export function flagsInc8(flags, before, result) {
    const r8 = result & 0xFF;
    let f = flags.value;
...
export function flagsInc16(flags, before, result) {
    const r16 = result & 0xFFFF;
    let f = flags.value;
    f = PARITY_TABLE[r16 & 0xFF] ? (f | FLAG.PF) : (f & ~FLAG.PF);
    f = (before ^ 1 ^ result) & 0x10 ? (f | FLAG.AF) : (f & ~FLAG.AF);
...
export function flagsDec8(flags, before, result) {
    const r8 = result & 0xFF;
    let f = flags.value;
    // CF intentionally NOT written.
    f = PARITY_TABLE[r8] ? (f | FLAG.PF) : (f & ~FLAG.PF);
...
export function flagsDec16(flags, before, result) {
    const r16 = result & 0xFFFF;
    let f = flags.value;
    f = PARITY_TABLE[r16 & 0xFF] ? (f | FLAG.PF) : (f & ~FLAG.PF);
    f = (before ^ 1 ^ result) & 0x10 ? (f | FLAG.AF) : (f & ~FLAG.AF);
