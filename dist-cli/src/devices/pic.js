export class PIC8259 {
    ...
    constructor(controller, options = {}) {
        ...
        if (this.dataPort !== this.commandPort + 1) {
            ...
            throw new Error(`PIC8259: dataPort (0x${this.dataPort.toString(16)}) must be ` +
    ...
    // ============================================================
    getIRR() { return this.irr; }
    getISR() { return this.isr; }
    getIMR() { return this.imr; }
    getVectorBase() { return this.vectorBase; }
    getInitState() { return this.initState; }
    getReadSelector() { return this.readSelector; }
    // ============================================================
    ...
    handleOcw2(v) {
        ...
        if (!specific) {
            ...
            if (this.isr === 0)
                return; // EOI with no in-service IRQ: documented no-op
