...
const IMAGE_SPECS: Readonly<Record<Filesystem, ImageSpec>> = {
  fat: {
...
function buildVariant(filesystem: Filesystem, srcOverride: string | null, dstOverride: string | null): void {
  ...
  process.stdout.write(
    `Wrote serial-console image (${filesystem}): ${dstAbs}\n` +
    `Source: ${srcAbs}\n` +
