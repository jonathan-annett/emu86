import { linearAddress, type Word } from '../core/types.js';
...
function pushPostDecrementSP(cpu: CPU8086): void {
...
// ============================================================
function pushSreg(idx: 0 | 1 | 2 | 3): OpcodeHandler {
  return (cpu) => cpu.push(cpu.regs.getSreg(idx));
}
function popSreg(idx: 0 | 1 | 2 | 3): OpcodeHandler {
...
function readWordAt(cpu: CPU8086, segment: Word, offset: Word): Word {
