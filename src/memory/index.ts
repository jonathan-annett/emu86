export { DEFAULT_PAGE_SIZE, readWordViaBytes, writeWordViaBytes } from './memory.js';
export type { Memory } from './memory.js';
export { InMemoryPageStore } from './page-store.js';
export type { PageStore } from './page-store.js';
